...
const ALL_MODULES: AppModule[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'logistics-dispatch-exec',      label: 'Execution',             path: ROUTES.logisticsDispatchExecution,    icon: Zap          },
      { key: 'operations-section',           label: 'Operations',            isSection: true },
      { key: 'logistics-operations',         label: 'Operations Center',     path: ROUTES.logisticsOperations,           icon: Activity     },
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'hr-explain',    label: 'Explainability', path: ROUTES.hrCompensationExplainability, icon: Search },
      ...
      { key: 'hr-offers',     label: 'Offers',         path: ROUTES.hrOffers,             icon: FileSignature },
      { key: 'hr-tags',       label: 'Applicant Tags', path: ROUTES.hrApplicantTags,      icon: Tags          },
      { key: 'hr-recruit-analytics', label: 'Recruitment Analytics', path: ROUTES.hrRecruitmentAnalytics, icon: BarChart2 },
      { key: 'hr-exits',      label: 'Employee Exit',  path: ROUTES.hrExits,              icon: DoorOpen      },
