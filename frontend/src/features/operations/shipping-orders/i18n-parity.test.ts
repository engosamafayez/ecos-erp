...
import en from '@/i18n/locales/en/shipping-orders.json';
import ar from '@/i18n/locales/ar/shipping-orders.json';

/**
 * TASK-ECOS-SHIPPING-OS-REDESIGN-003 §22 — EN/AR parity for the new `trip`
 * column and `drawer.*` keys this task added.
 */
...
describe('shipping-orders i18n parity', () => {
