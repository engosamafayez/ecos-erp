      ...
      {!isLoading && (
        <div className="grid grid-cols-3 gap-px bg-border mx-0">
          {[
            ...
            { label: `EGP ${totalCollected.toLocaleString('en-EG', { minimumFractionDigits: 2 })}`, value: 'Collected' },
          ].map((kpi) => (
      ...
      <div className="p-4 space-y-3">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-muted-foreground">
            ...
            <p className="text-sm mt-1">Trips will appear here when dispatched.</p>
          </div>
        )}
      </div>
    </div>
