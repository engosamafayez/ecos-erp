...
const SOURCE_OPTIONS: SourceOption[] = [
  {
    ...
    description: 'Merge one or more approved material requests into this purchase',
  },
  {
    sourceType: 'direct',
        ...
        <div className="space-y-2 pt-1">
          {SOURCE_OPTIONS.map((opt) => (
            <button
              ...
              className="flex w-full items-center gap-4 rounded-lg border bg-background p-4 text-left transition-colors hover:border-primary/50 hover:bg-accent"
            >
...
export function PurchasesPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <PageHeader
        title="Purchases"
        subtitle="Procurement decision workspace — supplier selection, approval, and execution."
        actions={
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm whitespace-nowrap">
                <thead className="bg-muted/40 border-b">
                  <tr>
                    <th className="px-3 py-3 text-left font-medium text-xs text-muted-foreground">Purchase #</th>
                    <th className="px-3 py-3 text-left font-medium text-xs text-muted-foreground">Source</th>
                    ...
                    <th className="px-3 py-3 text-left font-medium text-xs text-muted-foreground">Buyer</th>
                    ...
                    <th className="px-3 py-3 text-right font-medium text-xs text-muted-foreground">Approved Value</th>
                      ...
                      <td colSpan={13} className="px-4 py-12 text-center">
                        ...
                        {!search && statusFilter === 'all' && (
                          <p className="text-xs text-muted-foreground mt-1">
                            Click "New Purchase" to create your first purchase order.
                          </p>
                        )}
                      </td>
                    </tr>
