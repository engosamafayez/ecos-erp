    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'right' &&
            'data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 end-0 h-full w-full md:w-[80vw] lg:w-[60vw] sm:max-w-none border-s',
          side === 'left' &&
            'data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 start-0 h-full w-full md:w-[80vw] lg:w-[60vw] sm:max-w-none border-e',
          side === 'top' &&
