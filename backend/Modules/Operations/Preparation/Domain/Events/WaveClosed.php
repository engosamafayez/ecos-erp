...
final class WaveClosed implements DomainEvent
{
    use Dispatchable;
    ...
    public function __construct(
        ...
        public readonly string $reason = 'scheduled',
    ...
    public function eventName(): string            { return 'preparation.wave.closed'; }
    ...
    public function toArray(): array
    {
        return [
            ...
            'triggered_by'      => $this->closedBy,
            'triggered_by_type' => $this->closedBy === 'system' ? 'system' : 'user',
            'payload'           => [
                'wave_id'       => $this->waveId,
