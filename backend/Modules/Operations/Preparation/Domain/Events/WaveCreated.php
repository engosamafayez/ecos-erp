...
final class WaveCreated implements DomainEvent
{
    use Dispatchable;
    ...
    public function __construct(
        ...
        public readonly string  $configVersionId,
    ...
    public function eventName(): string    { return 'preparation.wave.created'; }
    ...
    public function toArray(): array
    {
        return [
            ...
            'payload'           => [
                ...
                'config_version_id' => $this->configVersionId,
            ],
        ];
    }
