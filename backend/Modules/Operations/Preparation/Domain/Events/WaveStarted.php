...
final class WaveStarted implements DomainEvent
{
    use Dispatchable;
     ...
     * @param list<array{user_id:string,role:string}>          $workersAssigned
     */
    public function __construct(
        ...
        public readonly array  $workersAssigned    = [],
    ...
    public function eventName(): string        { return 'preparation.wave.started'; }
    ...
    public function toArray(): array
    {
        return [
            ...
            'payload'           => [
                ...
                'workers_assigned' => $this->workersAssigned,
            ],
        ];
    }
