...
final class OrderRemovedFromWave implements DomainEvent
{
    use Dispatchable;
    ...
    public function eventName(): string            { return 'preparation.wave.order_removed'; }
    ...
    public function toArray(): array
    {
        return [
            ...
            'triggered_by'      => $this->removedBy,
            'triggered_by_type' => $this->removedBy === 'system' ? 'system' : 'user',
            'payload'           => [
                'wave_id'      => $this->waveId,
