...
final readonly class TenderAdded implements DomainEvent
{
    ...
    public function eventName(): string            { return 'pos.payment.tender_added'; }
    ...
    public function toArray(): array
    {
        return [
            ...
            'type'                  => $this->type,
            'tender_amount'         => $this->tenderAmount,
