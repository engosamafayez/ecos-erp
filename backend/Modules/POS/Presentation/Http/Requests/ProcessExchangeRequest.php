...
final class ProcessExchangeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'returned_lines.*.unit_price'              => ['required', 'numeric', 'min:0'],
            'returned_lines.*.line_total'              => ['required', 'numeric', 'min:0'],
            ...
            'replacement_lines.*.unit_price'           => ['required', 'numeric', 'min:0'],
            'replacement_lines.*.line_total'           => ['required', 'numeric', 'min:0'],
