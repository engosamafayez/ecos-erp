...
final readonly class ShiftOpened implements DomainEvent
{
    ...
    public function eventName(): string { return 'pos.shift.opened'; }
    ...
    public function toArray(): array
    {
        return [
            ...
            'opening_cash_amount' => $this->openingCashAmount,
