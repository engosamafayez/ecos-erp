...
final readonly class ExchangeCancelled implements DomainEvent
{
    public function __construct(
        ...
        public string             $cancelledFromStatus,
    ...
    public function eventName(): string             { return 'pos.exchange.cancelled'; }
    ...
    public function toArray(): array
    {
        return [
            ...
            'cancelled_from_status'=> $this->cancelledFromStatus,
