...
final readonly class PromotionPaused implements DomainEvent
{
    ...
    public static function now(string $promotionId, string $name, string $pausedAt): self
    {
        return new self(
    ...
    public function eventName(): string             { return 'pos.promotion.paused'; }
