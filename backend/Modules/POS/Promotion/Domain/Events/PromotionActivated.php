...
final readonly class PromotionActivated implements DomainEvent
{
    ...
    public static function now(string $promotionId, string $name, string $activatedAt): self
    {
        return new self(
    ...
    public function eventName(): string             { return 'pos.promotion.activated'; }
