...
/**
 * Raised after a prior reservation is cancelled and stock returns to available pool.
 *
 * Publisher : ReleaseStockAction (after DB transaction commits)
 * Trigger   : Order cancellation before fulfilment
 */
final class InventoryStockReleased implements DomainEvent
{
    ...
    public function toArray(): array
    {
        return [
            ...
            'quantity_released' => $this->quantityReleased,
